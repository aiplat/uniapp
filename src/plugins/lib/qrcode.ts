/*
 * @FilePath: \src\plugins\lib\qrcode.ts
 * @Description:  用于小程序生成普通二维码
 * @Author: 第三方
 * @Date: 2020-07-10 15:46:53
 * @LastEditTime: 2020-09-24 17:27:02
 */
//---------------------------------------------------------------------
//
 ...
 */
var qrcode: any = function (typeNumber: any, errorCorrectLevel: any) {

	var PAD0: any = 0xEC;
	var PAD1: any = 0x11;

	var _typeNumber: any = typeNumber;
	var _errorCorrectLevel: any = QRErrorCorrectLevel[errorCorrectLevel];
	var _modules: any = null;
	var _moduleCount: any = 0;
	var _dataCache: any = null;
	var _dataList: any = new Array();
	...
	var createData = function (typeNumber: any, errorCorrectLevel: any, dataList: any) {
	...
	_this.createImgTag = function (cellSize: any, margin: any, size: any) {
		...
		const a: any = createImgTag(size, size, function (x: any, y: any) {
...
qrcode.stringToBytes = function (s:any) {
	var bytes = new Array();
...
var QRRSBlock: any = function () {
	...
	var getRsBlockTable = function (typeNumber: any, errorCorrectLevel: any) {
	...
	_this.getRSBlocks = function (typeNumber: any, errorCorrectLevel: any) {
...
var createImgTag: any = function (width: any, height: any, getPixel: any) {
...
var drawImg: any = function (text: any, options: any) {
	...
	const a: any = size / qr.getModuleCount();
	var cellsize = parseInt(a, 10);
	const b: any = (size - qr.getModuleCount() * cellsize) / 2;
	var margin = parseInt(b, 10);
