				...
				<ul class="cm_pc_12">
					...
					<li class="cm_pc_12 cm_prl05">
						<div class="cm_pc_12">
							...
							<div class="cm_pa cm_tr0 cm_hl3 cm_mr05 cm_c1c"  @click="$cm.toWin('',indexData.gitUrl2)">{{indexData.gitUrl}}</div>
						</div>
						<ul class="cm_pc_12 cm_pd05 cm_be">
							<li class="cm_pc_12 cm_pd05 cm_lh2 cm_bf cm_bb1ce" v-for="(v,k) in indexData.gitList" :key="k">
								<div class="cmtou" @click="$cm.toWin('',v.url)"><span class="cm_c1c cm_fwb">{{v.name}}</span>:<span class="cm_fs08">{{v.desc}}</span></div>
							</li>
						</ul>
					</li>
